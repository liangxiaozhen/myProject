...
<script type="text/javascript"
	src="${basePath}/js/admin/activityRule/gj_activityRule.js"></script>
</head>
<body>
	<div class="container">
		<div class="row">
					...
					<div class="col-md-5 input-group">
						...
						<div class="col-md-2 col-md-offset-3">
							<button class="btn btn-default"
								onclick="activityRule.low_findAll(this)">查询全部</button>
						</div>
					</div>
					<div class="col-md-12 text-right">
						<button class="btn btn-default"
							onclick="activityRule.low_save_button(this)">设置</button>
					</div>
					<div id="queryall_list" style="margin-top: 40px;">
						<jsp:include
							page="/WEB-INF/jsp/admin/activityRule/listTemplate.jsp"></jsp:include>
					</div>
				</div>
