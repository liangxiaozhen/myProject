...
<body>
	<div class="container" style="margin-top: 5px;">
		<div class="col-md-12">
			<div class="alert alert-success text-center" role="alert"
				style="font-size: 14px;">请先完成标的活动规则设置,然后再进行标的活动奖励规则设置</div>
			<div id="title">
				<ul class="nav nav-tabs">
					<li class="active"><a href="javascript:void(0)">标的活动规则设置</a></li>
					<li><a href="javascript:void(0)">标的活动奖励规则设置</a></li>
				</ul>
			</div>
			<form id="ActivityRule_from">
				...
				<div id="ActivityRule_box">
						...
						<div class="col-md-8">
							...
							<div class="col-sm-6">
								<input type="text" class="form-control" name="actname"
									id="actname" placeholder="请输入活动名称...">
							</div>
						</div>
					</div>
					...
					<div class="row" style="margin-top: 20px;">
						<div class="col-md-8">
							...
							<div class="col-sm-6">
								<input type="text" class="form-control" name="tdayrestrict"
									id="tdayrestrict" placeholder="请输入投标期限限制...">
							</div>
							<span class="red" id="" style="height: 35px; line-height: 35px;"></span>
						</div>
					</div>
					...
					<div class="row" style="margin-top: 20px;">
						<div class="col-md-8">
							...
							<div class="col-sm-6">
								<input type="text" class="form-control" name="tmlrrestrict"
									id="tmlrrestrict" placeholder="请输入投标收益限制最低值...">
							</div>
							<span class="red" id="" style="height: 35px; line-height: 35px;"></span>
						</div>
					</div>
					...
					<div class="row" style="margin-top: 20px;">
						<div class="col-md-8">
							...
							<div class="col-sm-6">
								<input type="text" class="form-control" name="tmhrrestrict"
									id="tmhrrestrict" placeholder="请输入投标收益限制最高值...">
							</div>
						</div>
					</div>
					...
					<div class="row" style="margin-top: 20px;">
						<div class="col-md-8">
							...
							<div class="col-sm-6">
								...
								<!-- 	 										//,onpicked:ActivityRule.check_actbtime(this) -->
					...
					<div class="row" style="margin-top: 20px;">
						<div class="col-md-8">
							<label for="exampleInputName2" class="col-sm-2 text-right">客户端限制</label>
					...
					<div class="row" style="margin-top: 20px;">
						<div class="col-md-8">
							<label for="exampleInputName2" class="col-sm-2 text-right">投标属性限制</label>
							<label class="checkbox-inline"><input type="checkbox"
						...
						<div class="col-md-6">
							<div class="text-center">
								<button type="button" class="btn btn-primary"
									onclick="ActivityRule.low_next(this)">下一步</button>
				...
				<!-- 标的活动奖励规则设置 start -->
				<div id="ActivityAwardRule_box" style="display: none;">
					<div class="row" style="margin-top: 20px;">
						<div class="col-md-8">
							<label for="exampleInputName2" class="col-sm-2 text-right">累投金额值_低位</label>
							<div class="col-sm-6">
								<input type="text" class="form-control" name="tminmoney"
									id="tminmoney" placeholder="请输入累投金额值_低位...">
							</div>
						</div>
					</div>
					...
					<div class="row" style="margin-top: 20px;">
						<div class="col-md-8">
							...
							<div class="col-sm-6">
								<input type="text" class="form-control" name="tmaxmoney"
									id="tmaxmoney" placeholder="请输入累投金额值_高位...">
							</div>
						</div>
					</div>
					...
					<div class="row" style="margin-top: 20px;">
						<div class="col-md-8">
							...
							<div class="col-sm-6">
								<input type="text" class="form-control" name="awardname"
									id="awardname" readonly="readonly" placeholder="请选择奖品ID...">
							</div>
						</div>
					</div>
					...
					<div class="row" style="margin-top: 20px;">
						<div class="col-md-8">
							...
							<div class="col-sm-6">
								<input type="text" class="form-control" name="awardprize"
									id="awardprize" placeholder="请输入奖项的名称...">
							</div>
						</div>
					</div>
					...
					<div class="row" style="margin-top: 20px;">
						<div class="col-md-8">
							...
							<div class="col-sm-6">
								<input type="text" class="form-control" name="awardcopies"
									id="awardcopies" placeholder="请输入奖品份数...">
							</div>
						</div>
					</div>
					...
					<div class="row" style="margin-top: 10px;" id="awardType2">
						<div class="col-md-8" style="margin-top: 10px;">
							...
							<div class="col-sm-6">
								<input type="text" id="awardratio" class="form-control"
									id="awardratio" name="awardratio" placeholder="请输入定额金额百分比..." />
							</div>
						</div>
						<div class="col-md-8" style="margin-top: 10px;">
					...
					<div class="row" style="margin-top: 20px;">
						<div class="col-md-8">
							...
							<div class="col-sm-6">
								<input type="text" class="form-control" name="firsttendermoney"
					...
					<div class="row" style="margin-top: 20px;">
						<div class="col-md-8">
							...
							<div class="col-sm-6">
								<input type="text" class="form-control" name="regeditdayrest"
									id="regeditdayrest" placeholder="请输入注册时间限制（多少天内）...">
							</div>
						</div>
					</div>
					...
					<div class="row" style="margin-top: 20px;">
						<div class="col-md-8">
							...
							<div class="col-sm-6">
								<input type="text" class="form-control" name="iprestrict"
									id="iprestrict" placeholder="请输入奖励IP次数限制...">
							</div>
						</div>
					</div>
					...
					<div class="row" style="margin-top: 20px;">
						<div class="col-md-8">
							...
							<div class="col-sm-6">
								<input type="text" class="form-control" name="cookierestrict"
									id="cookierestrict" placeholder="请输入奖励cookie次数限制...">
							</div>
						</div>
					</div>
						...
						<div class="col-md-8">
							...
							<div class="col-sm-6">
								<input type="text" class="form-control" name="ranking"
									id="ranking" placeholder="请输入排名类型...">
							</div>
						</div>
					</div>
					...
					<div class="row" style="margin-top: 25px;">
						<div class="col-md-6">
							<div class="text-center">
								...
								<button type="button" class="btn btn-info"
									onclick="ActivityRule.low_prev(this)">上一步</button>
	...
	var ActivityRule = {
			...
			low_next:function(){
				...
				$("#ActivityRule_box").hide();
				$("#title").find(".nav-tabs").find("li").removeClass("active").eq(1).addClass("active");
				$("#ActivityAwardRule_box").show();
 			},
			//根据奖品ID查询奖品名称
			...
			low_save:function(obj){
				if(!check().form()){
  				...
  				timer = setTimeout(function(){
	 				$.ajax({
						type:"post",
						url:basePath+"/admin/activityRule/save.action",
			...
			//上一步
			low_prev:function(){
				$("#ActivityAwardRule_box").hide();
				$("#title").find(".nav-tabs").find("li").removeClass("active").eq(0).addClass("active");
				$("#ActivityRule_box").show();
			},
			//奖励方式显示框
