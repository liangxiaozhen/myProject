...
<script
	src="${pageContext.request.contextPath}/js/interestexpense/insertInterestExpense.js"></script>
<style type="text/css">
#id {
	margin: 40px;
}
	...
	$("#submitBtu").click(function(){
		...
		if($("#nextPage").val()=="nextPage"){
			if(check().form()){
				...
				var url="${pageContext.request.contextPath}/interestExpense/insertInterestExpense.action";
		        ...
		        $.post(url,sendData,function(backData){
		        	...
		        	if($backData=="标设置完成"){
		        		...
		        		/* 直接新建标的相关设置成功后返回的页面*/
		        		window.location.href="${pageContext.request.contextPath }/interestExpense/selectInterestExpenseByCondition.action";
		        	}
		        });
		}
	});
...
<body style="font-family: '微软雅黑';">
	...
	<form
		action="${pageContext.request.contextPath}/interestExpense/insertInterestExpense.action"
		method="post" id="insertInterestExpenseForm">
		<input type="hidden" name="nextPage" id="nextPage"
			value="${nextPage }" />
		<div class="row" style="line-height: 0px;">
			<div class="col-md-4 " style="margin-top: 10px; margin-bottom: 10px">
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label><font
					size="5">设置利息管理费参数</font></label>
			</div>
		</div>
		<hr>
		<div class="row" style="line-height: 0px;">
			<div class="col-md-8 col-md-offset-1">
				<font size="3">利息管理费收款人</font>&nbsp;&nbsp;：<input type="text"
					name="ierecman" style="width: 200px; height: 25px; font-size: 15px" />
			</div>
		</div>
		<hr>
		<div id="chargetype2">
		...
		<div id="iepercent">
			<div class="row" style="line-height: 0px;">
				<div class="col-md-4 col-md-offset-1">
					<font size="3">利息管理费百份比</font>&nbsp;&nbsp;：<input type="text"
						name="iepercent"
						style="width: 100px; height: 25px; font-size: 15px" />
				</div>
				<div class="col-md-7 ">
					<font size="3">最低金额与最高金额：</font>&nbsp;&nbsp;：<input type="text"
						name="miniefee"
						style="width: 100px; height: 25px; font-size: 15px" />元&nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp;<input
						type="text" name="maxiefee"
		...
		<div class="row" style="line-height: 0px;">
			<div class="col-md-5">
				...
				<button id="backid" class="btn btn-success" name="backid"
					type="button" onclick="gotoInterestExpenseList()">返回列表</button>
			</div>
		</div>
	</form>
</body>
