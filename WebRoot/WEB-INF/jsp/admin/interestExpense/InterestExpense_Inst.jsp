...
<div  class="route_bg">
	...
	<a href="#">标的利息管理费设置页面</a>
</div>
<div class="container"  style="margin-top: 25px;">
			<form class="form-horizontal" role="form" action="${pageContext.request.contextPath}/admin/interestExpense/insertInterestExpensetwo.action" id="defaultForm">
				<!--利息管理费收款人-->
				<input type="hidden" name="tid" value="${tid}">
				<div class="form-group">
					<label for="IERecMan" class="col-sm-3 control-label laber_from">利息管理费收款人</label>
					<div class="col-sm-3">
						<input type="text" name="ierecman" id="IERecMan" placeholder="利息管理费收款人" class="form-control" value="MDT000001" readonly/>
					</div>
				</div>
				<input type="hidden" name="ierecmanid" id="IERecManId" value="0" />
				<!--会员等级-->
				...
				<!--百分比-->
				<div class="form-group">
					<label class="col-sm-3 control-label laber_from" for="IEPercent">利息管理费百分比</label>
					<div class="col-sm-3">
						<div class="input-group">
							<input type="text" name="iepercent" id="IEPercent" placeholder="利息管理费百分比" class="form-control" />
				...
				<%--	<div class="col-sm-3">
						<div class="input-group">
							<input type="text" name="miniefee" id="minIEFee" placeholder="该段最低利息管理收费金额" class="form-control" />
					...
					<div class="col-sm-3">
						<div class="input-group">
							<input type="text" name="maxiefee" id="maxIEFee" placeholder="该段最高利息管理收费金额" class="form-control" />
							<span class="input-group-addon">元</span>
						</div>
					</div>
				</div>
