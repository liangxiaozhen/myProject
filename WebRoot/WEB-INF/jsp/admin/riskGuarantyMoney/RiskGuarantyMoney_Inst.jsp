...
<head>
    ...
    <title>RiskGuarantyMoney_inst</title>
...
<div class="route_bg">
    ...
    <a href="#">标的风险保证金设置页面</a>
</div>
<div class="container" style="margin-top: 25px;">
    <form class="form-horizontal" role="form" id="defaultForm"
          action="${pageContext.request.contextPath}/admin/riskGuarantyMoney/insertRiskGuarantyMoneytwo.action">
        <input type="hidden" name="tid" value="${tid}">
        <!--风险保证金收款人-->
        <div class="form-group">
            <label for="RGMRecMan" class="col-sm-3 control-label laber_from">风险保证金收款人</label>
            <div class="col-sm-3">
                <input type="text" name="rgmrecman" id="RGMRecMan" placeholder="风险保证金收款人" class="form-control"
        ...
        <!--百分比-->
        <div class="form-group">
            <label class="col-sm-3 control-label laber_from" for="IEPercent">风险保证金百份比</label>
            <div class="col-sm-3">
                <div class="input-group">
                    <input type="text" name="rgmrate" id="IEPercent" placeholder="利息管理费百份比" class="form-control"/>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-3">
                <div class="input-group">
                    <input type="text" name="maxrgmfee" id="maxIEFee" placeholder="最高利息管理收费金额" class="form-control"/>
