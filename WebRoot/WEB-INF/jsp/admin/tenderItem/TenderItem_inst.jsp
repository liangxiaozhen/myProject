...
<div class="container" style="margin-top: 20px;">
    <form class="form-horizontal" method="post" id="form1"
          action="${pageContext.request.contextPath}/admin/tenderItem/insertTenderItem.action">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-3">
                <select name="valuerule" id="valueRule" class="form-control" onchange="selectTime(this)">
                    ...
                    <option value="1">生成还款日当天</option>
                    <option value="2">生成还款日次日</option>
                    <option value="3">生成还款日指定时间点前后</option>
                </select>
            </div>
        </div>
        ...
        <div class="form-group" id="valuePoint">
            ...
            <div class="col-sm-3">
                <input type="text" name="valuepoint" placeholder="起息时间点如:10:00:00" class="form-control"
        ...
        <div class="form-group">
            ...
            <div class="col-sm-3">
                <input type="text" name="tbegintime" class="form-control" id="inputtbegintime" placeholder="设置投标开始时间"
        ...
        <div class="form-group">
            ...
            <div class="col-sm-3">
                <select name="investerrange" id="investerrange" class="form-control" onchange="investerChange(this);">
                    ...
                    <option value="1">任何人皆可投标</option>
                    <option value="2">只允许新手投标</option>
                    <option value="3">按会员等级设置</option>
                    <option value="4">按定向名单设置</option>
                </select>
            </div>
        </div>
        <!--会员等级-->
            ...
            <div class="form-group">
                ...
                <div class="col-sm-3">
                    <label class="radio-inline">
                        <input type="radio" name="ugrestrict" id="uGradeone" value="1" class="insert-ugrade-radio"/>全部等级
                    </label>
                    <label class="radio-inline">
                        <input type="radio" name="ugrestrict" id="ugradetwo" value="2" class="insert-ugrade-radio"/>部分等级
                    </label>
                </div>
            </div>
        ...
        <div id="snlid">
            <div class="form-group">
                ...
                <div class="col-sm-3">
                    <select class="form-control" name="dingxiang" onchange="snlidChange(this);">
                        <option value="">请选择名单</option>
                        <c:if test="${!empty snl2}">
                            <c:forEach items="${snl2}" var="sn">
                                <option value="${sn.id},${sn.businessNo}">${sn.businessName}</option>
                            </c:forEach>
                        </c:if>
                    </select>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-3">
                <input type="text" name="onettimes" class="form-control" id="onettimes" placeholder="单人投标次数限制">
            </div>
        </div>
        <!--单笔允许投资金额最低与最高-->
        <div class="form-group">
            ...
            <div class="col-sm-3">
                <div class="input-group">
                    <input type="text" name="minoncetamount" class="form-control" id="minoncetamount"
                           placeholder="最低">
            ...
            <div class="col-sm-3">
                <div class="input-group">
                    <input type="text" name="maxoncetamount" class="form-control" id="maxoncetamount"
                           placeholder="最高">
                    <span class="input-group-addon">元</span>
                </div>
            </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-3 ">
                <select name="danbaoren" class="form-control" onchange="guaranteeChange(this);">
                    <option value="">请选择</option>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-3">
                <div class="input-group">
                    <input type="text" class="form-control" name="ocmaxday" id="OCMAXDAY" placeholder="逾期滞纳金计算截止天数"/>
                    <span class="input-group-addon">天</span>
                </div>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-3">
                <textarea rows="3" class="form-control" name="tdesc" id="tdesc"></textarea>
            </div>
        </div>
        <%--<!--是否为模板-->
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-1">
                <button type="button" class="btn btn-success" id="gobackList" onclick="gotoTenderItemList()">返回列表
                </button>
            </div>
            <div class="col-sm-1">
                <button type="button" class="btn btn-success" onclick="autoFill()">填写默认数据
                </button>
            </div>
        </div>
    </form>
...
<script type="text/javascript">
    function gotoTenderItemList() {
        window.location.href = "${pageContext.request.contextPath }/admin/tenderItem/selectloanAppbyappStatus.action";
    }
    //初始化部分内容 及 提前还款设置
    $(function () {
        var result = "${result}";
        ...
        $("#IntMode").hide();//利息设置:全部提前时:全额计息 占天计息
    ...
    function autoFill() {
        $("#tinterest").val("10");
        $("#valueRule").val("1");
        $("#inputtbegintime").val(getNowFormatDate());
        $("#inputtendtime").val(getNowFormatDateNext());
        $("#investerrange").val("1");
        $("#onettimes").val("10");
        $("#minoncetamount").val(100);
        $("#maxoncetamount").val(parseInt($("#tamount").val().replace(/,/g, '')));
        $("#inputismultiple").val("1");
        $("input[name='crestrict']").each(function () {
            $(this).attr("checked", true);
        });
        $("#repaysetmode").val("0");
        $("#repaymenttype1").val("1");
        $("#isapartrepay").val("1");
        $("#gracePeriod").val(3);
        $("#AheadPeriod").val(3);
        $("#OCMAXDAY").val("20");
    ...
    //获取当前的日期时间后5天的时间 格式“yyyy-MM-dd HH:MM:SS”
    function getNowFormatDateNext() {
        var date = new Date();
        var seperator1 = "-";
        var seperator2 = ":";
