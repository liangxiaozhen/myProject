...
-->
							...
							<c:forEach items="${sTime}" var="item">
								...
								${item.wlevel } </c:otherwise>
									...
									<td><fmt:formatNumber pattern="0.00"
											value="${item.minmoney }" />~<fmt:formatNumber pattern="0.00"
	...
	<div class="row" style="line-height: 0px;">
		<div class="col-md-4 col-md-offset-1">
			设置人员&nbsp;&nbsp;： <label>${wdcRstr.addman}</label>
		</div>
		<div class="col-md-5 ">
			设置时间&nbsp;&nbsp;： <label><fmt:formatDate
					value="${wdcRstr.addtime}" pattern="yyyy-MM-dd HH:mm:ss" /></label>
		</div>
	</div>
	<hr>
	<div class="row" style="line-height: 0px;">
