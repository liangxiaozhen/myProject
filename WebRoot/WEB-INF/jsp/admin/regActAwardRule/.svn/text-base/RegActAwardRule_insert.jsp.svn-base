		...
		<div class="row clearfix">
			<div class="col-md-12 column">
				<form method="post" id="insertRegActAwardForm"
					...
					action="${pageContext.request.contextPath}/admin/actAward/insertRegActAwardRule.action">
						...
						<div class="col-md-10">
							...
							<div class="col-sm-3">
								<select id="business" name="business" class="form-control"
									onchange="regInsert.selectBusiness(value)">
					...
					<div class="form-group">
						<div class="col-md-10">
							<label class="col-sm-4 text-right">客户端限制</label>
							<div class="col-sm-5">
						...
						<div class="col-md-10">
							...
							<div class="col-sm-3">
								<input type="text" id="awardno" name="awardno"
									class="form-control" onblur="regInsert.queryname(value)" /> <input
									type="hidden" id="awardid" name="awardid" /> <input
									type="hidden" id="actid" name="actid" value="${actid}" /> <input
									type="hidden" name="cid" value="${cid}" /> <small id="number"
					...
					<div class="form-group">
						<div class="col-md-10">
							...
							<div class="col-sm-4">
								<label id="aname"></label> <input type="hidden" id="awardname"
									name="awardname" />
							</div>
						</div>
					</div>
							...
							<div class="col-sm-2">
								<div class="input-group">
									<input type="text" name="awardcopies" class="form-control"
										placeholder="请输入奖品份数" onblur="regInsert.queryCopies(value)" />
							...
							<div class="col-sm-2">
								<div class="input-group">
									<input type="text" name="quota" class="form-control"
										placeholder="请输入奖励定额金额" /> <span class="input-group-addon">元</span>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="col-md-10">
							...
							<div class="col-sm-4">
								<textarea rows="5" name="remark" class="form-control"
									placeholder="注册活动奖励规则备注"></textarea>
							</div>
						</div>
					</div>
						...
						<div class="col-md-12">
							<div class="col-sm-7 text-right">
								...
								<input type="button" class="btn" value="保存本活动"
									onclick="regInsert.save(this)" style="margin-right: 20px;" />
								<c:if test="${cover ne 'cover'}">
									<input type="button" class="btn" value="返回上一页"
										onclick="regInsert.previousPage(this)" />
								</c:if>
							</div>
						</div>
					</div>
