...
<script type="text/javascript">
	...
	function select_asl2(){
		...
		//alert("asl2>>>"+asl2);
		var asl2Text = $("#add_small_list2").find("option:selected").text();//添加小名单，第二个下拉框选中的text值
	...
	function deleteAps(bt){
		...
		//alert("zui==="+document.getElementById("add_person_show").value);
		if(aps==""){
	...
	$(function(){
		...
		if(awardSmallList!=""){
			...
			document.getElementById("addSmallList_show").value=str.substring(0,str.lastIndexOf(","));
		...
		//alert("excludeSmallList"+excludeSmallList);
		if(excludeSmallList!=""){
			//将排除小名单按逗号切开
			var arr= new Array();
  		...
  		<form class="form-horizontal" id="" action="" method="post" >
	  		...
	  		<div class="form-group  has-feedback" style="display:none;">
	   			...
	   			<div class="date col-sm-9" id="datetimeActSet">
	   				<input type="text" style="border-radius:5px;line-height:28px;width: 200px" id="" name="" value="" class="Wdate" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})"/> 
	   			</div>
	  		</div>
  			...
  			<!-- 排除小名单 -->
	   		...
	   		<div class="form-group  has-feedback" id="ap_show" style="display:none ">
	   			 ...
	   			 <!-- <div class="col-sm-10" id="ap_show2"></div> -->
	   		</div>
	  		...
	  		<div class="form-group has-success has-feedback" >
				...
				<!-- <div class="col-sm-3">
		    		<button type="button" id="continueToInsert" class="btn btn-default">继续添加</button>			   		
				</div> -->
				<div class="col-sm-3">
