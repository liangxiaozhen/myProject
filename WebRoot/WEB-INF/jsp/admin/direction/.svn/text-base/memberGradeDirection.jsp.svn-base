...
<script type="text/javascript">
	...
	$(function(){
		...
		if(excludeIndividualUser!=""){
			...
			for(var i=0; i<arr.length; i++){
				var html =  "<div id='dp'  style='display:inline;'>"+
 							"&nbsp;&nbsp;&nbsp;<button type='button' id='' class='btn btn-default' onclick='deleteThisrename(this)' value='"+arr[i]+"' style='margin-right:15px;'>"+
 			   				""+arr[i]+"<span style='color:red' class='glyphicon glyphicon-remove'></span>"+
  			    			"</button></div>";       
   				$("#dp_show").append(html);
			}
		...
		$("#saveDirection").click(function(){
			var action = "<%=basePath%>admin/nameList/saveDirection.action?nameMode="+2;
		...
		<div class="col-md-12 column">
			<form class="form-horizontal" id="" action="" method="post">
				...
				<div id="system_business" class="form-group  has-feedback">
					...
					<div class="col-sm-9">
						<select class="aos" style="border-radius: 4px;" name="sbt"
							id="sbt" onchange="select_sbt();">
				...
				<div class="form-group  has-feedback" id="sbt_show"
					style="display: none">
					<font class="control-label col-sm-2">系统业务展示：</font> <input
						type="hidden" name="systemBusType" id="systemBusType">
					<div id="sbt_text"></div>
				</div>
				...
				<div id="is_risk" class="form-group  has-feedback">
					...
					<div class="col-sm-9">
						...
						<input type="radio" id="isRisk0" name="isRisk" value="0" checked="checked" />否
					</div>
				</div>
				...
				<div id="message_notice" class="form-group  has-feedback">
					...
					<div class="col-sm-9">
						<select class="aos" style="border-radius: 4px;" name="ste"
							id="ste" onchange="select_ste();">
							<option value="0">--请选择--</option>
							<c:forEach var="smy" items="${smtype}">
								<option value="${smy.key}">${smy.value}</option>
							</c:forEach>
						</select> <span id="mn" style="color: red;"></span>
					</div>
				</div>
				<div class="form-group  has-feedback" id="ste_show"
					style="display: none">
					<font class="control-label col-sm-2">短信通知展示：</font> <input
						type="hidden" name="smsType" id="smsType">
					<div id="ste_text"></div>
				</div>
				...
				<div class="form-group  has-feedback">
					...
					<div class="col-sm-3">
						<input type="text" id="businessNo" name="businessNo"
							value="${snl.businessNo}"
							style="width: 400px; border-style: none;" readonly />
					</div>
				</div>
				...
				<div class="form-group  has-feedback">
					...
					<div class="col-sm-3">
						<input type="text" style="border-style: none;" readonly
							id="addMan" value="${adminuser.username}" />
					</div>
				</div>

				<div id="set_time" class="form-group  has-feedback"
					style="display: none;">
					...
					<div class="date col-sm-9" id="datetimeActSet">
						<input type="text"
							...
							id="addTimeStr" name="addTimeStr" value="${snl.addTimeStr}"
							class="Wdate"
				...
				<div class="form-group  has-feedback">
					...
					<div class="col-sm-3">
						<input type="text" id="generateType" name="generateType"
							value="${snl.generateType}"
							style="width: 400px; border-style: none;" readonly="true" />
					</div>
				</div>
				...
				<div id="addMemberGrade" class="form-group  has-feedback">
					...
					<div class="col-sm-9">
						<select class="aos" style="border-radius: 4px;"
							id="add_member_grade" onchange="select_amg();">
				...
				<div class="form-group has-feedback" id="amg_show"
					style="display: none">
					<font class="control-label col-sm-2">添加会员展示：</font> <input
						type="hidden" name="memberGrade_show" id="memberGrade_show">
					<div id="amg"></div>
				</div>
				...
				<div id="addPerson" class="form-group  has-feedback" id="listAdd">
					...
					<div class="col-sm-4">
						<button type="button" onclick="import_person();">
							新增<span class="glyphicon glyphicon-pencil"></span>
						</button>
					</div>
				</div>
				<div class="form-group  has-feedback" id="ap_show"
					style="display: none">
					<font class="control-label col-sm-2">添加个人展示：</font> <input
						type="hidden" name="add_person_show" id="add_person_show">
					<div id="ap"></div>
				</div>

				<!-- 排除大名单 -->
				<div id="debarBigList" class="form-group  has-feedback"
					style="display: block">
					<font class="control-label col-sm-2" style="line-height: 10px;">排除大名单：</font>
					<div class="col-sm-9">
						<select class="aos" style="border-radius: 4px;"
							id="debar_big_list" onchange="select_dbl();">
				...
				<div class="form-group  has-feedback" id="dbl_show"
					style="display: none">
					<font class="control-label col-sm-2" style="line-height: 10px;">排除大名单展示：</font>
					<input type="hidden" name="debarBigList_show"
						id="debarBigList_show">
					<div id="dbl"></div>
				</div>
				...
				<div id="debarSmallList" class="form-group  has-feedback">
					...
					<div class="col-sm-9">
						<select class="aos" style="border-radius: 4px;"
							id="debar_small_list1" onchange="select_dsl1();">
							<option value="0">--请选择--</option>
							<c:forEach items="${removeNames}" var="rn">
								<option value="${rn.nametype}">${rn.nametype}</option>
							</c:forEach>
						</select> <select class="aos" style="border-radius: 4px;"
							id="debar_small_list2" onchange="select_dsl2();">
							<option value="0">--请选择--</option>
						</select>
					</div>
				</div>
				<div id="dsl_show" class="form-group  has-feedback"
					style="display: none">
					<font class="control-label col-sm-2">排除小名单展示：</font> <input
						type="hidden" name="debarSmallList_show" id="debarSmallList_show">
					<div id="dsl"></div>
				</div>
				...
				<div class="form-group  has-feedback">
					...
					<div class="col-sm-4">
						<button type="button" onclick="export_person();">
							新增<span class="glyphicon glyphicon-pencil"></span>
						</button>
					</div>
				</div>
				<div class="form-group  has-feedback" id="dp_show"
					style="display: none">
					<font class="control-label col-sm-2">排除个人展示：</font> <input
						type="hidden" name="debar_person_show" id="debar_person_show">
					<div id="dp"></div>
				</div>
				...
				<div class="form-group  has-feedback">
					...
					<div class="col-sm-8">
						<textarea type="text" id="remark" name="remark"
							class="form-control" value="${snl.remark}">${snl.remark}</textarea>
					</div>
				</div>
