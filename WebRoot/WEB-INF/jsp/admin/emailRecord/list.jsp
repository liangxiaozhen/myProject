...
<script type="text/javascript"
	src="${basePath}/js/admin/emailRecord/gj_emailRecord.js"></script>
</head>
<body>
	<div class="container">
		<div class="row">
					...
					<div class="col-md-5 input-group">
						...
						<div class="col-md-2 col-md-offset-3">
							<button class="btn btn-default"
								onclick="emailRecord.low_findAll(this)">查询全部</button>
						</div>
					</div>

					<div id="queryall_list" style="margin-top: 40px;">
						<jsp:include
							page="/WEB-INF/jsp/admin/emailRecord/listTemplate.jsp"></jsp:include>
					</div>
				</div>
