    ...
    <form action="${pageContext.request.contextPath}/admin/failTCompensate/insertfailTAwardCompensate.action" method="post" role="form" class="form-horizontal" id="bookFormtwo">
 		<!--奖品补偿方式-->
			...
			<div id="AwardCompensateOn_div">
				...
				<!--分段最低投资金额-最高金额-->
				<div id="InputsWrappertwo">
					<div class="form-group">
						<label class="col-sm-3 control-label" for="minMoneyAward">分段投资最低金额-最高金额</label>
						<div class="col-sm-3">
							<div class="input-group">
								<input type="text" name="awardCompensates[0].minmoneyaward" id="minMoneyAward"
						...
						<div class="col-sm-3">
							<div class="input-group">
								<input type="text" name="awardCompensates[0].maxmoneyaward" id="maxMoneyAward"
									class="form-control" placeholder="分段投资金额最高" /> <span
									class="input-group-addon">元</span>
							</div>
						</div>
						<div class="col-sm-1">
				...
				<div id="InputsWrapper" class="hide form-remove">
					<div class="form-group">
						<label class="col-sm-3 control-label" for="minMoneyAward">分段投资最低金额-最高金额</label>
						<div class="col-sm-3">
							<div class="input-group">
								<input type="text" name="minmoneyaward" id="minMoneyAward" class="form-control" placeholder="分段投资金额最低" />
								<span class="input-group-addon">元</span>
							</div>
						</div>
						<div class="col-sm-3">
							<div class="input-group">
								<input type="text" name="maxmoneyaward" id="maxMoneyAward" class="form-control" placeholder="分段投资金额最高" />
								   <span class="input-group-addon">元</span>
							</div>
						</div>
						<div class="col-sm-1">
	...
	$("#bookFormtwo").bootstrapValidator({
	  ...
	  // Add button click handler
        .on('click', '.addButtontwo', function() {
            ...
            $('#bookFormtwo')
                .bootstrapValidator('addField', 'awardCompensates[' + bookIndex + '].minmoneyaward', minMoneyAward)
        ...
        .on('click', '.removeButtontwo', function() {
            ...
            // Remove fields
            $('#bookFormtwo')
                .bootstrapValidator('removeField', $row.find('[name="awardCompensates[' + index + '].minmoneyaward"]'))
                .bootstrapValidator('removeField', $row.find('[name="awardCompensates[' + index + '].maxmoneyaward"]'))
                .bootstrapValidator('removeField', $row.find('[name="awardCompensates[' + index + '].awardno"]'));
