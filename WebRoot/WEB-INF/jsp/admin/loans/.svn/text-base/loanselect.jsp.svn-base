...
<head>
    ...
    <script type="text/javascript">
        ...
        //是否允许建标
        function loanappPass(id, appstatus) {
            url = "loanappPass.action?id=" + id + "&appstatus=" + appstatus;
    ...
    <div class="row clearfix">
        <div class="col-md-12 column">
            ...
            <form id="selectgfundsIntByCondition" method="post"
                  action="${pageContext.request.contextPath}/admin/loan/selectloanappAudit.action">
            ...
            <table class="table table-hover " id="personList_table">
                ...
                <c:forEach items="${pagehelper.list }" var="gfundsInt">
                    <tr class="text-center">
                        ...
                        <td>
                            <a href="${pageContext.request.contextPath}/admin/loanmaterial/lookuserloanMaterial.action?loanno=${gfundsInt.loanno}">查看资料</a>
                        </td>
                        <td>
                            <c:choose>
                        ...
                        <td>
                            <c:choose>
                                <c:when test="${gfundsInt.isaitender ==0}">
                                    <button class="btn btn-default" onclick="loanappPass('${gfundsInt.id}','3')">
                                        允许建标
                                    </button>
                                    <button class="btn btn-default" id="modify"
                                            onclick="loanappPass('${gfundsInt.id}','2')">不允许
                                    </button>

                                    <button class="btn btn-default"
                                            onclick="toUpdateUi('${gfundsInt.id}')">修改
                                    </button>
                                </c:when>
                            </c:choose>
                        </td>
