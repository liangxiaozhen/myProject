			                ...
			                <li class="pad">
			                    <div class="user">
			                      <div class="ico-p pos1"></div>
			                         <input type="text" name="loginName" id="uname2" onblur="chkvalue(this)" class="userName1 gray_border " autocomplete="off" placeholder="请输入用户名/手机号/邮箱"/>
			                ...
			                <li class="pad">
			                  <div class="user">
			            					 <div class="ico-p pos2"></div>
			            						<input type="password" name="pwd" id="pwd2" onblur="chkvalue(this)" class="userName2 gray_border " autocomplete="off" placeholder="请输入密码" />
...
<script type="text/javascript" src="<%=basePath%>resources/resource/Scripts/gt.js"></script>
				 ...
				 $.ajax({
				  ...
				  success:function(returnData){
						  if(returnData!="Y") {
							    ...
							    var fwurl="<%=basePath%>qq/bangDingQQLogin.action"; 
								<%-- var fwurl="<%=basePath%>/third/varifyPsw.action"; --%>
...
<script>
	...
	function regAccount(){
		window.location.href="<%=basePath%>qq/lgIndexForQQ.action";
	}
</script>
