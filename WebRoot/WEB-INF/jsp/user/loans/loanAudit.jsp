...
<body>
	<div class="container" id="finishBaseInfo">
		<div id="ht">
			<h2>
				<span class="glyphicon glyphicon-edit"></span><em>添加借款人信息</em>
			</h2>
		</div>
		<div class="col-md-12 column">
			<form action="<%=basePath%>/loan/insertloan.action" method="post"
				class="form-horizontal" id="defaultForm">
				<div class="form-group has-success has-feedback">
					<label class="control-label col-sm-2" for="inputSuccess3">用户姓名：</label>
					<label class="control-label col-sm-1" style="color: red;">${user.realname}</label>
					<div class="col-sm-5">
						<input type="hidden" value="${user.realname}" class="form-control"
