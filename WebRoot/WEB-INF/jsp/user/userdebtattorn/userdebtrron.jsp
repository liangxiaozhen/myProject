...
function operation(id){
	var action =basePath+"/user/userdebtattorn/queryAllRecord.action";
	var params ={
			"id":id
	}
	$.post(action,params,function(data){
...
$("#operationts51").click(function(){
	  ...
	  $("#operationts4").css("background","#FFFFFF");
});
...
$("#operationts4").click(function(){
	  $("#operationts4").css("background","#FF9900");
	  $("#operationts1").css("background","#FFFFFF");
	  $("#operationts2").css("background","#FFFFFF");
	  $("#operationts3").css("background","#FFFFFF");
	  $("#operationts51").css("background","#FFFFFF");
...
<body>
	<div id="operationts">
		...
		<div onclick="operationts(51)" id="operationts51">可转让的</div>
		<div onclick="operation(1)" id="operationts1">待审核</div>
		<div onclick="operation(2)" id="operationts2">已上架</div>
		<div onclick="operation(3)" id="operationts3">已下架</div>
		<div onclick="operation(4)" id="operationts4">已完成</div>
		<!-- <span>
					持有时间:<select> 
								<option>30天</option>
								<option>60天</option>
	...
	<div id="transferable">
		<jsp:include
			page="/WEB-INF/jsp/user/userdebtattorn/userdebtrron_status51.jsp"></jsp:include>
	</div>
</body>
</html>