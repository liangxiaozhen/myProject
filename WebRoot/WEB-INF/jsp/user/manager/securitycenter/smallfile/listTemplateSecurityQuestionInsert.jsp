...
<tr class="validation-status clearfix">
	...
	<td class="bor_b wid_w200 fc_6"><div class="pad_l30">
			<a class="showNext qus_shez" title="立即设置" href="javascript:;" id="questionBind">立即设置</a>
		</div></td>
</tr>
<c:choose>
				 	...
				 	<td colspan="4">
						<div class="mar_auto safe-protect">
							...
							<div class="steps steps_4 clearfix pad_t20 flowstep pad_b20">
								...
								<ul id="safeQuestionStep2" class="wid_w160 fl txt_center">
									<li class="sz step-no fc_9"><span>2</span></li>
									<li class="sm txt_center pad_t10">2.设置安全保护问题</li>
								</ul>
								<ul id="safeQuestionStep3" class="wid_w160 fl txt_center">
									<li class="sz step-no fc_9"><span>3</span></li>
									<li class="sm txt_center pad_t10">3.确认安全保护问题</li>
								</ul>
								<ul id="safeQuestionStep4" class="wid_w160 fl step-last txt_center">
									<li class="sz step-no fc_9"><span>4</span></li>
									<li class="sm txt_center pad_t10">4.完成</li>
								</ul>
							</div>
							<!--安全问题 step1 Start-->
							<div id="questionStep1" class="bank_step step1 pad_t20">
									...
									<tbody>
										...
										<tr>
											...
											<th valign="top"
												...
												type="text" maxlength="6" id="quverify"
												class="input_a100 ui-input w180-input itxt"> <span
												style="display: block;" class="inputVlue">请填写验证码</span>
												<button onclick="securitycenter.sendSSmBySQInsert(this);" id="questionInsertSSM"
													class="button button-w120 mar_l10">点击获取</button>
												<button id="questionInsertSSMTip" style="display: none"
													class="button button-w120 mar_l10" type="button"></button> <br>
											<span style="display: block;" id="verifyMSG6"
												class="prompt_1 error_1"><em></em>请输入验证码！</span></th>
										</tr>
										<tr>
											<th>&nbsp;</th>
											<th class="rightside">
												<button class="btn btn_36c btn_size120" onclick="securitycenter.securityQuestionInsertOne(this);" id="securityQuestionInsertOne">下一步</button>
											</th>
										</tr>
									</tbody>
								</table>
							...
							<!--安全问题 step2 Start-->
							<div id="questionStep2" class="bank_step step2 none">
								<table class="table_child fc_3 fs_14 form" width="100%"
									cellspacing="0" cellpadding="0">
									<tbody>
										<tr>
											<th class="leftside pad_b20" colspan="2">
												<div class="clearfix wid_466 mar_auto pad_t30">
													<div id="allMsgSite" class="yellow clearfix">
														...
														<span id="allQuestionMsgError" class="fs_14 vertical_middle">密保问题可用于找回登录密码操作</span>
													</div>
												</div>
											</th>
										</tr>
										<tr>
											...
											<th class="rightside pad_b20"><select id="IquestionOne"
												class="w212 ui-input w320-input">
													<option id="question1" name="question1" value="-1">请选择问题</option>
										...
										<tr>
											...
											<th class="rightside pad_b20"><input type="text"
												id="Ianswer1" name="answer1" maxlength="20"
												class="input_all ui-input w320-input"></th>
										</tr>
										<tr>
											<th class="leftside pad_b20">问题二</th>
											<th class="rightside pad_b20"><select id="IquestionTwo"
												class="w212 ui-input w320-input">
													<option id="question2" name="question2" value="-1">请选择问题</option>
													<option value="1">您母亲的生日是？</option>
													<option value="2">您母亲的姓名是？</option>
													<option value="3">您父亲的生日是？</option>
													<option value="4">您父亲的姓名是？</option>
										...
										<tr>
											<th class="leftside pad_b20">答案</th>
											<th class="rightside pad_b20"><input type="text"
												id="Ianswer2" name="answer2" maxlength="20"
												class="input_all ui-input w320-input"></th>
										</tr>
										<tr>
											<th class="leftside pad_b20">问题三</th>
											<th class="rightside pad_b20"><select id="IquestionThree"
												class="w212 ui-input w320-input">
													<option id="question3" name="question3" value="-1">请选择问题</option>
													<option value="1">您母亲的生日是？</option>
													<option value="2">您母亲的姓名是？</option>
													<option value="3">您父亲的生日是？</option>
													<option value="4">您父亲的姓名是？</option>
										...
										<tr>
											<th class="leftside pad_b20">答案</th>
											<th class="rightside pad_b20"><input type="text"
												id="Ianswer3" name="answer3" maxlength="20"
												class="input_all ui-input w320-input"></th>
										</tr>
										<tr>
											<th></th>
											<th class="rightside">
												<button type="button"
													class="btn btn_36c btn_size120" onclick="securitycenter.securityQuestionInsertTwo(this);" id="securityQuestionInsertTwo">下一步</button>
											</th>
										</tr>
									</tbody>
								</table>
							...
							<!--安全问题 step3 Start-->
							<div id="questionStep3" class="bank_step step3 none">
									...
									<tbody>
										<tr>
											...
											<th valign="top" class="rightside pad_b20"><input type=""
												...
												id="Iquestion2-1" readonly="readonly" value=""></th>
										</tr>
										<tr>
											<th valign="top" width="92" class="leftside pad_b20 pad_t10">答案</th>
											<th valign="top" class="rightside pad_b20"><input type=""
												autocomplete="off" class="input_all ui-input w320-input"
												id="Ianswer2-1" readonly="readonly" value=""></th>
										</tr>
										<tr>
											<th valign="top" width="92" class="leftside pad_b20 pad_t10">问题二</th>
											<th valign="top" class="rightside pad_b20"><input type=""
												autocomplete="off" class="input_all ui-input w320-input"
												id="Iquestion2-2" readonly="readonly" value=""></th>
										</tr>
										<tr>
											<th valign="top" width="92" class="leftside pad_b20 pad_t10">答案</th>
											<th valign="top" class="rightside pad_b20"><input type=""
												autocomplete="off" class="input_all ui-input w320-input"
												id="Ianswer2-2" readonly="readonly" value=""></th>
										</tr>
										<tr>
											<th valign="top" width="92" class="leftside pad_b20 pad_t10">问题一</th>
											<th valign="top" class="rightside pad_b20"><input type=""
												autocomplete="off" class="input_all ui-input w320-input"
												id="Iquestion2-3" readonly="readonly" value=""></th>
										</tr>
										<tr>
											<th valign="top" width="92" class="leftside pad_b20 pad_t10">答案</th>
											<th valign="top" class="rightside pad_b20"><input type=""
												autocomplete="off" class="input_all ui-input w320-input" name=""
												id="Ianswer2-3" readonly="readonly" value=""></th>
										</tr>
										<tr>
											<th valign="top" width="92" class="leftside pad_b20 pad_t10">&nbsp;</th>
											<th valign="top" class="rightside pad_b20">
												<button type="button" class="btn btn_36c btn_size120" onclick="securitycenter.securityQuestionInsertThree(this);" id="securityQuestionInsertThree">确定</button>
											</th>
										</tr>
									</tbody>
								</table>
							...
							<!--安全问题 step4 Start-->
							<div id="questionStep4" class="bank_step step4 pad_t20 pad_b20 none">
