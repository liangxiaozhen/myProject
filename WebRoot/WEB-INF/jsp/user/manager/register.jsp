...
<script type="text/javascript">
	...
	var namerule="${nameRule}";
	var ischinese ="${isChinese}";
</script>
</head>
<body>
	<!--head-->
	...
	<div class="clearfix simpleHead01">
		...
		<div class="fr">
			<span class="fc_6">已有帐号？<a
				href="${pageContext.request.contextPath }/user/tologin.action"
				...
				<div class="content">
					<form action="registerSecondSteps.action" method="post"
						...
						<table class="k touzi01">
							...
							<tr>
								...
								<td>
									...
									<input type="hidden" id="imgcode" name="imgcode" /> <span
									id="imgCodeMSG" style="display: none"></span>
								</td>
							</tr>
							<tr class="hight_auto">
								<th></th>
						...
						<div class="right_all">
							...
							<div class="colors color1" id="qq-login-id"
								onclick="thirdLoginFn(this)">
								<span><img style="width: 20px;"
									src="${pageContext.request.contextPath }/resources/Images/qq.png"></span>QQ登录
							</div>
							<div class="colors color2" id="weixin-login-id"
								onclick="thirdLoginFn(this)">
								<span><img style="width: 24px;"
									src="${pageContext.request.contextPath }/resources/Images/wx.png"></span>微信登录
							</div>
							<div class="colors color3" id="weibo-login-id"
								onclick="thirdLoginFn(this)">
								<span><img style="width: 24px;"
									src="${pageContext.request.contextPath }/resources/Images/wb.png"></span>新浪微博登录
							</div>
						</div>
					</form>
				</div>
	...
	<script type="text/javascript"
		src="${pageContext.request.contextPath }/resources/resource/Scripts/register1.js"></script>
	<script type="text/javascript"
		src="${pageContext.request.contextPath }/resources/resource/Scripts/commonquick.js"></script>
	...
	<script type="text/javascript">
		...
		function thirdLoginFn(txt){
			...
			if(id=="weixin-login-id"){
				<%-- window.location.href="<%=basePath%>/qq/lgIndex.action?uImg="+uImg+"&nkName="+nkName; --%>
				
			}else if(id=="qq-login-id"){
				window.location.href="${pageContext.request.contextPath }/qq/register.action";
			}else{
