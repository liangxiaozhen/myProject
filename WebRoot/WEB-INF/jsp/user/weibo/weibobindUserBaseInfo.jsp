...
<body>
	<div class="container">
		<div class="row" style="margin-top: 80px;">
			<div class="col-md-6">
				<div class="title text-center">已注册用户?立即登录并绑定微博</div>
			...
			<div class="col-md-6" id="regPhone">
				<div class="title text-center">没有注册用户？请注册并绑定微博</div>
				<div class="col-md-10 col-md-offset-2" style="margin-top: 20px;">
					<label class="col-sm-2 text-right">用户名:</label>
					<div class="col-sm-6">
   		...
   		var ThirdBindUser = {
			...
			bindUser:function(obj){
				 ...
				 if(isEmpty(password)){
  				 ...
  				 $.ajax({
 					 type:"post",
 					 url:basePath+"/sian/thirdBindUser.action",
 					 data:params,
 			...
 			registerBindUserPassedPhone:function(obj){
 				...
 				$.ajax({
					 type:"post",
					 url:basePath+"/sian/thirdBindUserAndRegisterPassedPhone.action",
					 data:params,
					 success:function(data){
 						 var obj = $.parseJSON(data);
 						  $("#bind_phone_bindUserError").text("");
 						 if(obj.result == "username_null"){
							 ...
							 $("#bind_phone_bindUserError").text("注册用户并绑定微博失败");  
						 }else if(obj.result == "logout"){
 				...
 				var code =$("#bind_email_code").val();
 			 	...
 			 	if(isEmpty(code)){
   				...
   				var params = {"username":username,"email":email,"password":password,"code":code,"ecode":ecode};
 	 				$.ajax({
 						 type:"post",
 						 url:basePath+"/sian/thirdBindUserAndRegisterPassedEmail.action",
 						 data:params,
 						 success:function(data){
 	 						 var obj = $.parseJSON(data);
 			...
 			sendPhondCode:function(){
 				...
 				$.ajax({
					 type:"post",
					 url:basePath+"/sian/sianPhoneCode.action",
					 data:params,
					 success:function(data){
						 var obj = $.parseJSON(data);
 			...
 			sendEmailCode:function(){
 				...
 				$.ajax({
					 type:"post",
					 url:basePath+"/sian/sendEmailCode.action",
					 data:params,
					 success:function(data){
						 var obj = $.parseJSON(data);
  						 if(obj.result == "email_null"){
