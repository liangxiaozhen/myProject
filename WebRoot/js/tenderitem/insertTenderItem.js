var insertTenderItem = {
	    ...
	    init: {
	        ...
	        initEvent: function(){
	        	...
	        	$(".insert-ugrade-radio-ugrestrict").bind("change",function(){
	        		insertTenderItem.other.ugrestrictChange();
	        	});
	        	
	        	//为保存按钮增加click事件
	        	$("#submitBtu").unbind("click");
	        	$("#submitBtu").bind("click",function(){
	        		insertTenderItem.other.saveClick();
	        	});
	    ...
	    other:{
         ...
         clearNoNum:function(obj){
        	...
        	saveClick:function(){
        		//表单提交时的验证
        		if(insertTenderItem.other.check().form()||insertTenderItem.other.chenck_totalmoneyrestrict()){
    				$("form:first").submit();
    			}
        	},
	        ...
	        check:function(){
	        	// 在键盘按下并释放及提交后验证提交表单
	        	return $("#insertTenderItemForm").validate({
...
$(function(){
	insertTenderItem.other.initPage();
	insertTenderItem.init.initEvent();
});
