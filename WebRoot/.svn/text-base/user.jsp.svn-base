...
<script type="text/javascript">
	...
	function queryAllPerson(pageNum, pageSize){
		...
		$("#edit_area_div").load("user/query.action?pageNum="+pageNum+"&pageSize="+pageSize+"&name="+name+"&usersalary="+usersalary);
	}
</script>
</head>
	...
	<div class="container">
		<div class="row clearfix">
			<div class="col-md-12 column"
				style="border-style: none; border-width: 0px; border-color: Black; background-color: none;">
				...
				user_salary:<input type="text" id="usersalary" name="usersalary"
					value="" /> <br /> <br />
