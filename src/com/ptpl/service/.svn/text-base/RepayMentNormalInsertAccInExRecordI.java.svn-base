...
/**
 * 
 * @ClassName: RepayMentNormalInsertAccInExRecordI 
 * @Description: TODO(正常还款 收支记录) 
 * @author cjm 
 * @date 2017年6月19日 下午7:03:30 
 *
 */
public interface RepayMentNormalInsertAccInExRecordI {
	 ...
	 * @throws
	 */
	void InsertNormalRepayMentCountAccInExRecord(RepayMent repayMent);
}
