 ...
 * 
 * 标的活动奖励规则Dao接口层
 * ActivityAwardRuleMapper
 * 创建人:chenjiaming
 * 时间：2016年08月26日 16:14:51
 * @version 1.0.0
 *
 */
public interface ActivityAwardRuleMapper {
    ...
    * @throws
     ...
     * 
     * @Title: updateById 
     * @Description: TODO(标的活动奖励规则 更新方法) 
     * @param @param activityAwardRule
     * @param @return  参数说明 
     * @return int    返回类型 
     * @author chenjiaming
     ...
     * @Description: TODO(标的活动奖励规则 查询全部) 
     * @param @param activityAwardRule
     * @param @return  参数说明 
     * @return int    返回类型 
     * @author chenjiaming
    ...
    * @Description: TODO(根据Id查询对应的标的活动奖励规则 信息) 
    * @param @param id
    * @param @return  参数说明 
