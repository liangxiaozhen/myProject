 ...
 * 
 * 用户托管账户信息Dao接口层
 * UserFsAccountInfoMapper
 * 创建人:chenjiaming
 * 时间：2016年08月10日 12:20:02
 * @version 1.0.0
 *
 */
public interface UserFsAccountInfoMapper {
    ...
    * @throws
     ...
     * 
     * @Title: updateById 
     * @Description: TODO(用户托管账户信息 更新方法) 
     * @param @param userFsAccountInfo
     * @param @return  参数说明 
     * @return int    返回类型 
     * @author chenjiaming
     ...
     * @Description: TODO(用户托管账户信息 查询全部) 
     * @param @param userFsAccountInfo
     * @param @return  参数说明 
     * @return int    返回类型 
     * @author chenjiaming
    ...
    * @Description: TODO(根据Id查询对应的用户托管账户信息 信息) 
    * @param @param id
    * @param @return  参数说明 
