...
public class WebUtils 
{
	...
	public static void setExpiresHeader(HttpServletResponse response,long expiresSeconds)
	{
	 ...
	 /**
	  * 根据浏览器if-Modified-Since Header
	  * 计算文件是否已经被修改 如果无修改 checkIfModify返回false
	  * 设置304 not modify status
	  * @param lastModified 内容最后被修改时间
	  */
	 ...
	 /**
	  * 根据浏览器 if-None-Match Header,计算Etag是否已经无效
	  * 如果Etag有效,checkIfNoneMatch返回false
	  * 设置304 not modify status
	  * @param etag 内容的Etag
	  */
