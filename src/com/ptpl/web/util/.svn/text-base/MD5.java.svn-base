...
//		}
		...
		String str1 = m.getMD5Info(str);
		System.out.println(str1);
		String[] strings = StringUtil.splitString(str1);
		System.out.println(strings[0]);
		System.out.println(strings[1]);
		String str3 = "jia3550563";
		String str4 = m.getMD5Info(str);
		String[] str5 = StringUtil.splitString(str4);
		System.out.println(str5[1].equals(strings[1]));
 	}
