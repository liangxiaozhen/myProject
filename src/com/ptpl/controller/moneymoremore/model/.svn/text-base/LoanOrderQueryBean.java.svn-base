...
public class LoanOrderQueryBean
{
	 ...
	 */
	//private Integer SecondaryState;
	...
	public String toString() {
		return "LoanOrderQueryBean [LoanOutMoneymoremore=" + LoanOutMoneymoremore + ", LoanInMoneymoremore="
				+ LoanInMoneymoremore + ", LoanNo=" + LoanNo + ", OrderNo=" + OrderNo + ", BatchNo=" + BatchNo
				+ ", ExchangeBatchNo=" + ExchangeBatchNo + ", AdvanceBatchNo=" + AdvanceBatchNo + ", Amount=" + Amount
				+ ", PlatformMoneymoremore=" + PlatformMoneymoremore + ", TransferAction=" + TransferAction
				+ ", Action=" + Action + ", TransferType=" + TransferType + ", TransferState=" + TransferState
				+ ", TransferTime=" + TransferTime + ", ActState=" + ActState + ", ActTime=" + ActTime + ", ActNo="
				+ ActNo + ", SecondaryState=" + SecondaryState + ", SecondaryTime=" + SecondaryTime
				+ ", SecondaryJsonList=" + SecondaryJsonList + ", TransferName=" + TransferName + ", Remark=" + Remark
				+ "]";
	}
