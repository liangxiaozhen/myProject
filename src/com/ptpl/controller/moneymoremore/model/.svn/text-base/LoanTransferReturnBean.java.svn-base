...
public class LoanTransferReturnBean
{
	...
	public String toString() {
		return "LoanTransferReturnBean [LoanJsonList=" + LoanJsonList + ", PlatformMoneymoremore="
				+ PlatformMoneymoremore + ", Action=" + Action + ", RandomTimeStamp=" + RandomTimeStamp + ", Remark1="
